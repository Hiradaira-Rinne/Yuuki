...
public class PermissionDO implements Serializable {
    @Serial
    private static final long serialVersionUID = 9146252339905335667L;
    ...
    @Column(name = "permission_name", columnDefinition = "varchar(20) comment '权限名称'")
    private String permissionName;

    @Column(name = "description", columnDefinition = "varchar(500) comment '描述'")
    private String description;

    @Column(name = "status", columnDefinition = "varchar(1) comment '权限状态(0-正常， 1-停用)'")
